...
const translations = {
  en: {
    ...
    analytics_text: 'Text',
    analytics_images: 'Images',
    analytics_pinned: 'Pinned',
    analytics_week: 'This Week',
    analytics_daily_activity: 'Daily Activity (30 days)',
    analytics_top_apps: 'Top Source Apps',
    analytics_types: 'Type Distribution',
    analytics_hourly: 'Hourly Activity',
    // time
    just_now: 'just now',
  },
  vi: {
    ...
    analytics_refresh: 'Làm mới',
    analytics_total: 'Tổng cộng',
    analytics_today: 'Hôm nay',
    analytics_text: 'Văn bản',
    analytics_images: 'Hình ảnh',
    analytics_pinned: 'Đã ghim',
    analytics_week: 'Tuần này',
    analytics_daily_activity: 'Hoạt động 30 ngày',
    analytics_top_apps: 'Ứng dụng hay dùng',
    analytics_types: 'Phân loại',
    analytics_hourly: 'Theo giờ',
    // time
    just_now: 'vừa xong',
  },
} as const
